...
export const CATALOG = {
  ...
  cooler: [
    ...
    c('cool-lf360', 'Arctic Liquid Freezer III Pro 360', 109, { kind: 'aio', rad: 360, fan: '#161616', info: 'AiO-Wasserkühlung · 360 mm' }),
    c('cool-lf360w', 'Arctic Liquid Freezer III Pro 360 A-RGB (Weiß)', 129, { kind: 'aio', rad: 360, fan: '#eeeeee', rgb: true, info: 'AiO · 360 mm · weiß mit RGB' }),
  ...
  mousepad: [
    ...
    c('mp-zero', 'Artisan Ninja FX Zero XSoft XL', 69, { size: [490, 420], color: '#1b1b1d', info: 'Nicos Empfehlung · Balance Speed/Control' }),
...
export const KB = {
  ...
  pcbs: [
    ...
    c('kpcb-he', 'Hall-Effect-PCB (Magnet-Switches, Rapid Trigger)', 85, { rgb: true, he: true, info: 'nur für Magnet-Switches' }),
    c('kpcb-wl', 'Hot-Swap-PCB Tri-Mode (Bluetooth/2.4 GHz/Kabel)', 75, { rgb: true, info: 'kabellos' }),
  ],
  switches: [
    c('sw-y2', 'Keygeek × MZ Y2', 0.35, { type: 'linear', color: '#3b3b40', pitch: 0.74, info: 'linear · Lumekeebs Top-Pick · vollster Thock', unchecked: true }),
    c('sw-y3', 'Keygeek × MZ Y3', 0.35, { type: 'linear', color: '#d8d2c4', pitch: 0.82, info: 'linear · cremig, marmorig', unchecked: true }),
    c('sw-xiaoba', 'Keygeek Xiaoba', 0.3, { type: 'linear', color: '#f1c3c8', pitch: 0.9, info: 'linear · leicht (34 g) · creamy', unchecked: true }),
    c('sw-rosewood', 'Akko Rosewood', 0.31, { type: 'linear', color: '#7a3b2e', pitch: 0.8, info: 'linear · tief & warm', unchecked: true }),
    c('sw-iceking', 'Durock Ice King', 0.5, { type: 'linear', color: '#dfeaf2', pitch: 0.83, damp: 0.2, info: 'linear · gedämpfter Thock', unchecked: true }),
    c('sw-bsplit', 'C³Equalz × TKC Banana Split', 0.65, { type: 'linear', color: '#f3dc6b', pitch: 0.85, info: 'linear · Klassiker für Thock', unchecked: true }),
    c('sw-ks20', 'Gateron KS-20 Magnetic (Hall-Effect)', 0.45, { type: 'linear', color: '#e8e8e8', pitch: 0.95, magnetic: true, info: 'Magnet · Rapid Trigger · braucht HE-PCB', unchecked: true }),
